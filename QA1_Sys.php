...
<h1 align=center>我要回答 1</h1>
<div class=out1 style='text-align:center'><img src="./images/Q1.jpg" width="550px"></div>
...
$now = time();
	...
	{
		require_once("server.php");
		$sql = "insert into quiz1(Class,NO,Name,Text) values('" .$class . "','".$NO . "','". $name . "','".$answer . "')";
		mysql_query($sql);
	}
}
