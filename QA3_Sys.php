...
<h1 align=center>我要回答 3</h1>
<div class=out1 style='text-align:center'><img src="./images/Q3.png" width="550px"></div>
...
$now = time();
	...
	{
		require_once("server.php");
		$sql = "insert into quiz3(Class,NO,Name,Text) values('" .$class . "','".$NO . "','". $name . "','".$answer . "')";
		mysql_query($sql);
	}
}
